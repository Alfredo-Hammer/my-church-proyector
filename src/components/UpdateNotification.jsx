...
const UpdateNotification = () => {
  ...
  const handleCheckUpdate = async () => {
    ...
    if (window.electron?.checkForUpdates) {
      ...
      if (result?.error) {
        ...
        setUpdateState("error");
        setError(
          "Las actualizaciones están deshabilitadas en modo desarrollo.",
        );
      }
    }
  };
  ...
  const releaseNotes = (() => {
    ...
    if (Array.isArray(raw)) {
      ...
      return raw
        .flatMap((r) => {
          const v = stripHtml(typeof r === "string" ? r : r?.note || "");
          return v ? [v] : [];
        })
        .join("\n\n");
    }
            ...
            <div className="p-6">
              ...
              {updateState === "checking" && (
                <div className="text-center py-2">
                  <div className="inline-flex items-center justify-center size-14 rounded-full bg-blue-500/15 mb-4">
              ...
              {updateState === "available" && (
                <div>
                  <div className="flex items-start gap-4 mb-5">
                    <div className="flex-shrink-0 size-12 rounded-xl bg-emerald-500/15 flex items-center justify-center">
              ...
              {updateState === "downloading" && (
                <div>
                  <div className="flex items-center gap-4 mb-5">
                    <div className="flex-shrink-0 size-12 rounded-xl bg-blue-500/15 flex items-center justify-center">
              ...
              {updateState === "not-available" && (
                <div className="text-center py-2">
                  <div className="inline-flex items-center justify-center size-14 rounded-full bg-emerald-500/15 mb-4">
              ...
              {updateState === "error" && (
                <div>
                  <div className="flex items-start gap-4 mb-5">
                    <div className="flex-shrink-0 size-12 rounded-xl bg-red-500/15 flex items-center justify-center">
                  ...
                  <div className="bg-red-900/20 border border-red-500/20 rounded-xl p-3 mb-5">
                    <p className="text-xs text-red-300 leading-relaxed">
                      {error ||
                        "Error desconocido. Verifica tu conexión a internet e intenta de nuevo."}
                    </p>
                  </div>
