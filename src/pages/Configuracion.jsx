...
const FONT_OPTIONS = [
  ...
  {valor: "text-10xl", etiqueta: "4XL", px: "160px", sample: "Aa"},
  {valor: "text-11xl", etiqueta: "5XL", px: "200px", sample: "Aa"},
];

const LOGO_SIZES = [
  {valor: "size-56", etiqueta: "Pequeño"},
  {valor: "size-64", etiqueta: "Mediano"},
  {valor: "size-80", etiqueta: "Grande"},
  {valor: "size-96", etiqueta: "Extra"},
...
function Card({icon, title, accent = "indigo", children, className = ""}) {
  ...
  return (
    <div
      className={`bg-slate-900/60 border border-white/7 rounded-2xl overflow-hidden flex flex-col ${className}`}
    >
      <div
        className={`${a.header} px-5 py-3.5 flex items-center gap-3 shrink-0`}
      >
...
function Toggle({checked, onChange, color = "indigo"}) {
  ...
  return (
    <label className="relative inline-flex cursor-pointer shrink-0">
      ...
      />
      <div
        className={`w-10 h-[22px] bg-slate-700 rounded-full transition-colors peer ${colors[color] || colors.indigo}
      ...
      <div className="flex items-center gap-3">
        <div className="relative shrink-0">
          <input
            ...
            className="size-11 rounded-xl border border-white/10 cursor-pointer bg-transparent p-1 block"
          />
        </div>
        <input
          type="text"
        ...
        {/* Muestra de color */}
        <div
          className="size-11 rounded-xl border border-white/10 shrink-0"
...
const TABS = [
  {
    id: "identidad",
    label: "Identidad",
    icon: <FaChurch className="text-[11px]" />,
  },
  {
    id: "apariencia",
    label: "Apariencia",
    icon: <FaPalette className="text-[11px]" />,
  },
  {
    id: "proyector",
    label: "Proyector",
    icon: <FaFont className="text-[11px]" />,
  },
];

const inputCls =
  "w-full px-3.5 py-2.5 bg-slate-800/80 border border-white/8 hover:border-white/15 focus:border-indigo-500/50 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none transition-colors";
...
const Configuracion = () => {
  ...
  const [splitActivo, setSplitActivo] = useState(
    ...
    try {
      ...
      if (config && Object.keys(config).length > 0) {
        const merged = {
          ...
          // Reconstruir el objeto anidado fontSize para que los controles lean el valor correcto.
          fontSize: {
            titulo:
              config.fontSizeTitulo ||
              config.fontSize?.titulo ||
              CONFIG_DEFAULTS.fontSize.titulo,
            parrafo:
              config.fontSizeParrafo ||
              config.fontSize?.parrafo ||
              CONFIG_DEFAULTS.fontSize.parrafo,
            eslogan:
              config.fontSizeEslogan ||
              config.fontSize?.eslogan ||
              CONFIG_DEFAULTS.fontSize.eslogan,
          },
        };
  ...
  const procesarArchivoLogo = (archivo) => {
    if (!archivo?.type?.startsWith("image/")) {
      mostrarMensaje("Archivo no válido", "error");
      return;
    }
  ...
  const guardarConfiguracionCompleta = async (cfg = configuracion) => {
    ...
    const flat = {
      ...
      fontSizeEslogan: cfg.fontSize?.eslogan || "text-3xl",
        ...
        <div className="p-4 xl:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[1fr_1fr_1.4fr] gap-4 items-start">
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  >
                    <div className="size-24 rounded-2xl bg-slate-800/80 border border-white/8 overflow-hidden p-1">
                      <img
                        src={logoSrc}
                        alt="Logo"
                    ...
                    <div className="text-center px-3">
                      ...
                      <p className="text-[10px] text-slate-600 mt-1">
                        PNG, JPG · Recomendado 500×500 px
                      </p>
                    </div>
                    {archivoLogo && (
                      <button
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (e.target.files[0])
                        procesarArchivoLogo(e.target.files[0]);
                    }}
                  />
                  ...
                  <div className="space-y-1 pt-1">
                    ...
                    {[
                      ...
                      {
                        campo: "mostrarNombreIglesia",
                        label: "Mostrar nombre",
                        color: "emerald",
                      },
                      {
                        campo: "mostrarEslogan",
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      aria-label="Eslogan de la iglesia"
                    />
                  </div>
                  <div>
                    <label
                      htmlFor="config-pastor"
                      className="block text-xs font-medium text-slate-400 mb-1.5"
                    >
              ...
              <div className="md:col-span-2 xl:col-span-1">
                <Card
                  icon={<IoEye />}
                  title="Vista Previa del Proyector"
                  accent="cyan"
                >
                  {/* Contenedor 16:9 con max-height para que no sea enorme */}
                  <div
                    className="relative w-full rounded-2xl overflow-hidden bg-slate-950 border border-white/6"
                  ...
                  >
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 px-6">
                      {configuracion.mostrarLogo && (
                        <img
                          src={logoSrc}
                          alt="Logo"
                          className="size-12 xl:w-16 xl:h-16 object-contain"
                          onError={(e) => {
                            e.target.src = "/images/icon-256.png";
                          }}
                        />
                      )}
                      {configuracion.mostrarNombreIglesia &&
                        configuracion.nombreIglesia && (
                          <p
                            className="text-lg xl:text-2xl font-bold text-center leading-tight"
                            style={{color: configuracion.colorPrimario}}
                          >
                            {configuracion.nombreIglesia}
                          </p>
                        )}
                      {configuracion.mostrarEslogan &&
                    ...
                    <span className="absolute bottom-1.5 right-2.5 text-[9px] text-slate-700 font-mono select-none">
                      16:9
                    </span>
                  </div>
                  ...
                  <div className="mt-4 flex gap-3">
                    <div className="flex-1 flex items-center gap-2 bg-slate-800/50 rounded-xl px-3 py-2.5 border border-white/5">
                      <div
                        className="size-4 rounded-full shrink-0 border border-white/10"
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[1fr_1.5fr] gap-4 items-start">
              ...
              >
                ...
                <div className="flex gap-4 items-start">
                  ...
                  >
                    <div
                      className="relative rounded-2xl overflow-hidden bg-slate-950 border border-white/6"
          ...
          {tab === "proyector" && (
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
              ...
              <Card
                icon={<FaFont />}
                title="Tamaño de Texto en Pantalla"
                accent="cyan"
              >
                <div className="space-y-5">
                  {[
                    {
                      tipo: "titulo",
                      label: "Título del Himno / Versículo",
                      color: "cyan",
                      max: 9,
                    },
                    {
                      tipo: "parrafo",
                      label: "Párrafo / Letra del Himno",
                      color: "cyan",
                      max: 9,
                    },
                    {
                      tipo: "eslogan",
                      label: "Eslogan en Pantalla de Inicio",
                      color: "cyan",
                      max: 4,
                    },
                  ].map(({tipo, label, color, max}) => {
                    const found = FONT_OPTIONS.find(
                      (o) => o.valor === configuracion.fontSize[tipo],
                    );
                    return (
                      <div key={tipo} className="space-y-2">
                        ...
                        <FontPicker
                          ...
                          onChange={(v) => {
                            const nueva = {
                              ...configuracion,
                              fontSize: {...configuracion.fontSize, [tipo]: v},
                            };
                            setConfiguracion(nueva);
                            guardarSilencioso(nueva);
                          }}
                  ...
                  {/* Vista previa del texto del proyector */}
                  <div className="border-t border-white/5 pt-4">
                    <p className="text-[10px] font-semibold text-slate-600 uppercase tracking-widest mb-2">
                      Vista previa — cómo se verá en pantalla
                    </p>
                    <div
                      className="relative w-full rounded-xl overflow-hidden bg-slate-950 border border-white/6 flex flex-col items-center justify-center gap-2 px-4"
                      style={{minHeight: "140px"}}
                    >
                      {/* Título de himno */}
                      <p
                        className={`${configuracion.fontSize.titulo} font-bold text-center leading-tight truncate w-full`}
                        style={{
                          color: configuracion.colorPrimario || "#fb923c",
                          fontSize: `clamp(14px, ${
                            ({
                              "text-3xl": "1.2vw",
                              "text-4xl": "1.5vw",
                              ...
                              "text-10xl": "5.5vw",
                              "text-11xl": "6.5vw",
                            }[configuracion.fontSize.titulo] || "2.3vw")
                          }, 38px)`,
                        }}
                      >
                        Santo, Santo, Santo
                      ...
                      {/* Párrafo de himno */}
                      <p
                        className="font-semibold text-center leading-snug whitespace-pre-line w-full"
                        style={{
                          ...
                          fontSize: `clamp(12px, ${
                            ({
                              ...
                              "text-10xl": "5.0vw",
                              "text-11xl": "6.0vw",
                            }[configuracion.fontSize.parrafo] || "3.2vw")
                          }, 32px)`,
                        }}
                      >
              ...
              <div className="space-y-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-0.5">
                          <p className="text-sm font-semibold text-slate-200">
                            Auto-dividir párrafos largos
                          </p>
                          {splitActivo && (
                            <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-violet-500/20 text-violet-300 border border-violet-500/30 uppercase tracking-wide">
                              Activo
                            </span>
                          )}
                        </div>
                        <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                          Divide himnos y textos largos en diapositivas para que
                          quepan en pantalla con texto grande y legible,
                ...
                <Card
                  icon={<IoImage />}
                  title="Tamaño del Logo en Pantalla"
                  accent="orange"
                >
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      if (r) {
                        await cargarFondos();
                        mostrarMensaje("Fondo subido", "success");
                      }
                    } catch {
                      mostrarMensaje("Error al subir", "error");
                    }
                  }}
                ...
                <div className="flex flex-col items-center justify-center py-20 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-slate-600 text-sm">
                      Sube imágenes o videos para usar como fondo
                    </p>
                  </div>
                </div>
              ) : (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-3">
                  {fondos.map((fondo) => (
                    <div
                      ...
                      onKeyDown={(e) =>
                        e.key === "Enter" && seleccionarFondo(fondo)
                      }
                      role="button"
                      tabIndex={0}
          ...
          <div className="relative max-w-4xl w-full">
            ...
            <div className="bg-gray-950 rounded-2xl overflow-hidden shadow-2xl border border-white/6">
              {previsualizandoFondo.tipo === "video" ? (
                <video
                  src={previsualizandoFondo.url}
                  className="w-full max-h-[70vh] object-contain"
                  controls
                  autoPlay
                  aria-label="Vista previa de video de fondo"
                />
              ) : (
                <img
                  src={previsualizandoFondo.url}
          ...
          <div className="bg-slate-900 border border-white/8 rounded-2xl shadow-2xl w-full max-w-sm">
            ...
            <div className="p-5">
              <p className="text-sm text-slate-300 mb-4 leading-relaxed">
                Se restablecerán todos los valores al estado por defecto. Esta
              ...
              <ul className="space-y-2 text-xs text-slate-500 mb-5">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2">
                    <IoInformationCircle className="text-slate-600 shrink-0 mt-0.5" />{" "}
                    {item}
                  </li>
                ))}
              </ul>
