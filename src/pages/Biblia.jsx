  ...
  return (
    <div className="bg-[#080c14] text-slate-100 h-full flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              ...
              <kbd className="text-[10px] bg-white/15 px-1.5 py-0.5 rounded">
                Ctrl+K
              </kbd>
            </button>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-3 xl:p-4">
        ...
        {libroSeleccionado ? (
          (() => {
            const nombreLibroActual =
              librosDeLaBiblia.antiguoTestamento
                .concat(librosDeLaBiblia.nuevoTestamento)
                .find((l) => l.id === libroSeleccionado)?.nombre || "";
            const esAT = librosDeLaBiblia.antiguoTestamento.some(
              (l) => l.id === libroSeleccionado,
            );
            return (
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-1.5 text-xs text-slate-500 px-0.5">
                  <IoBook
                    className={
                      esAT ? "text-amber-500/60" : "text-emerald-500/60"
                    }
                  />
                  <span
                    className={`font-semibold ${esAT ? "text-amber-400/80" : "text-emerald-400/80"}`}
                  >
                    {nombreLibroActual}
                  </span>
                  {capituloSeleccionado && (
                    ...
                    <div className="p-2.5 max-h-[24vh] lg:max-h-[30vh] overflow-y-auto">
                      {capitulos.length > 0 ? (
                        <div
                          ...
                          style={{
                            gridTemplateColumns:
                              "repeat(auto-fill, minmax(2.1rem, 1fr))",
                          }}
                        >
          ...
          <div className="flex flex-col items-center justify-center py-10 text-center">
            ...
            <p className="text-slate-600 text-xs mb-4 max-w-xs">
              Elige un libro del Antiguo o Nuevo Testamento para explorar sus
              capítulos y versículos
            </p>
            <button
              type="button"
              ...
              >
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-[10px] text-slate-700 tabular-nums">
                        {capituloSeleccionado}:{versiculoSeleccionado - 1}
                      </span>
                    </div>
                ...
                <div className="px-5 py-4 bg-indigo-500/5 border-b border-indigo-500/15">
                  <div className="flex items-center justify-between mb-2.5">
                    <span className="text-[10px] text-indigo-400/70 uppercase tracking-wider font-semibold">
                      Actual
                    </span>
                    <span className="text-[11px] text-indigo-400/50 tabular-nums">
                      {capituloSeleccionado}:{versiculoSeleccionado}
                    </span>
                  </div>
            ...
            <div className="px-4 pt-4 pb-3 border-b border-white/8 shrink-0">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500">
                      ↑↓ navegar · Tab/Enter seleccionar · Esc cerrar
                    </p>
                  </div>
                </div>
                <button
              ...
              {modoBuscador === "referencia" && (
                <div className="flex items-center gap-1">
                  {[
                    {n: 1, label: "Libro", color: "blue"},
                    {n: 2, label: "Capítulo", color: "green"},
                    {n: 3, label: "Versículo", color: "purple"},
                  ].map((step, i) => (
                    <div
                      key={step.n}
                    ...
                    >
                      ...
                      {i < 2 && (
                        <div
                          className={`w-4 h-px shrink-0 ${pasoActual > step.n ? "bg-white/30" : "bg-white/10"}`}
                        />
                      )}
                    </div>
                  ))}
                      ...
                      {capituloSeleccionadoBuscador && (
                        <>
                          ...
                          <span className="text-[11px] text-green-400 font-medium">
                            Cap. {capituloSeleccionadoBuscador}
                          </span>
                        </>
                      )}
                      {pasoActual > 1 && (
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter") buscarEnTodaLaBiblia();
                      }}
                    ...
                    !busquedaTexto.trim() && (
                      <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-xs text-slate-500">
                          Escribe una frase y presiona Buscar o Enter
                        </p>
                      </div>
                    )}
                  {!buscandoTexto &&
                  ...
                  {resultadosTexto.length > 0 && (
                    <div className="space-y-1">
                      <p className="text-[10px] text-slate-500 mb-2">
                        {resultadosTexto.length} resultado
                    ...
                    <div className="space-y-3">
                      <div>
                        <p className="text-[10px] text-amber-500/70 font-semibold uppercase tracking-wider mb-2 flex items-center gap-1.5">
                          <FaBookOpen className="text-[9px]" /> Antiguo
                          Testamento
                      ...
                      {resultadosBusqueda.map((resultado, index) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            {index === indiceSeleccionado && (
                              <span className="shrink-0 text-[10px] text-indigo-400 bg-indigo-500/15 border border-indigo-500/25 px-1.5 py-0.5 rounded">
                                Enter
                              </span>
                            )}
                          </div>
