...
import PlantillaGSAP from "./PlantillaGSAP";
  ...
  return (
    ...
    >
      {id === "revelar" && (
        <>
          <div
            className="absolute top-[15%] left-[8%] right-[8%] h-[2px]"
            style={{backgroundColor: acc, opacity: 0.8}}
          />
          <div
            className="absolute bottom-[15%] left-[8%] right-[8%] h-[2px]"
            style={{backgroundColor: acc, opacity: 0.8}}
          />
          <div
            className="absolute top-[9%] left-[5%] w-[14%] h-[22%] border-t-2 border-l-2"
            style={{borderColor: acc}}
          />
          <div
            className="absolute top-[9%] right-[5%] w-[14%] h-[22%] border-t-2 border-r-2"
            style={{borderColor: acc}}
          />
          <div
            className="absolute bottom-[9%] left-[5%] w-[14%] h-[22%] border-b-2 border-l-2"
            style={{borderColor: acc}}
          />
          <div
            className="absolute bottom-[9%] right-[5%] w-[14%] h-[22%] border-b-2 border-r-2"
            style={{borderColor: acc}}
          />
        </>
      )}
      {id === "neon" && (
        <>
          <div
            className="absolute inset-[8%] border-2 rounded"
            style={{
              borderColor: acc,
              boxShadow: `0 0 6px ${acc}, 0 0 16px ${acc}50`,
            }}
          />
          <div
      ...
      {id === "iglesia" && (
        <>
          <div
            className="absolute top-[8%] left-1/2 -translate-x-1/2 text-lg leading-none"
            style={{color: acc}}
          >
            ✝
          </div>
          <div
            className="absolute top-[26%] left-[12%] right-[12%] h-px"
            style={{backgroundColor: acc, opacity: 0.6}}
          />
          <div
      ...
      {id === "cinematica" && (
        <>
          ...
          />
          <div
            className="absolute left-[10%] top-[12%] bottom-[12%] w-[3px]"
            style={{backgroundColor: acc}}
          />
          <div
            className="absolute inset-0"
            style={{
              background: `linear-gradient(135deg, ${acc}12, transparent 60%)`,
            }}
          />
        </>
      )}
      {id === "particulas" && (
        <>
          ...
          <div
            ...
            style={{borderColor: acc, opacity: 0.25}}
          />
        </>
      )}
      {id === "gloria" && (
        <>
          <div
            className="absolute inset-0"
            style={{
              background: `radial-gradient(ellipse 60% 50% at 50% 50%, ${acc}18 0%, transparent 65%)`,
            }}
          />
          <div
          ...
          <div
            ...
            style={{borderColor: acc, opacity: 0.4}}
          />
        </>
      )}
      {id === "aurora" && (
        <>
          <div
            className="absolute w-[80%] h-[60%] top-[-15%] left-[-10%] rounded-full"
            style={{
              background: `radial-gradient(ellipse, ${acc}30, transparent 70%)`,
              filter: "blur(18px)",
            }}
          />
          <div
            className="absolute w-[60%] h-[50%] bottom-[-10%] right-[-5%] rounded-full"
            style={{
              background: `radial-gradient(ellipse, ${sec}20, transparent 70%)`,
              filter: "blur(14px)",
            }}
          />
        </>
      ...
      {id === "minimal" && (
        <>
          <div
            className="absolute top-[16%] left-[8%] right-[8%] h-[2.5px]"
            style={{backgroundColor: acc}}
          />
          <div
            className="absolute top-[16%] left-[8%] size-2.5 rounded-full -translate-y-[4px]"
            style={{backgroundColor: acc}}
          />
          <div
            className="absolute bottom-[16%] left-[8%] right-[8%] h-px"
            style={{backgroundColor: acc, opacity: 0.4}}
          />
        </>
      )}
      {id === "majestad" && (
        <>
          <div
            className="absolute inset-0"
            style={{
              background: `radial-gradient(ellipse 80% 60% at 50% 100%, ${acc}18 0%, transparent 60%)`,
            }}
          />
          {[
            "top-[6%] left-[5%]",
            ...
            <div
              key={`decor-${i}`}
              className={`absolute ${pos} w-[10%] h-[16%] border-[1.5px]`}
              style={{borderColor: acc, transform: "rotate(45deg)"}}
            />
          ))}
          <div
            className="absolute top-[20%] left-[12%] right-[12%] h-px"
            style={{backgroundColor: acc, opacity: 0.5}}
          />
          <div
            className="absolute bottom-[14%] left-[12%] right-[12%] h-px"
            style={{backgroundColor: acc, opacity: 0.5}}
          />
        </>
      )}
      {id === "olas" && (
        <>
          {[
            ...
            <div
              key={`decor-${i}`}
              className={`absolute left-0 right-0 ${h} rounded-full`}
              style={{top, backgroundColor: acc, opacity: op}}
            />
          ))}
          {[
            ["81%", "h-px", 0.3],
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
        <div className="text-xl mb-0.5 leading-none" style={{color: acc}}>
          {tpl.icono}
        </div>
        <div
          className="text-[7px] font-bold uppercase tracking-widest leading-none"
          style={{color: sec, opacity: 0.75}}
        >
          {tpl.nombre}
        </div>
      </div>
      ...
      {selected && (
        <div
          ...
          style={{backgroundColor: acc, opacity: 0.08}}
        />
      )}
    </div>
  );
...
export default function CreatePresentationModal({isOpen, onClose, onCreate}) {
  ...
  const tpl =
    TEMPLATE_LIST.find((t) => t.id === selectedId) || TEMPLATE_LIST[0];
        ...
        >
          ...
          <div className="shrink-0 px-5 py-3.5 border-b border-white/8 flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={onClose}
              className="size-7 flex items-center justify-center rounded-lg text-gray-500 hover:text-white hover:bg-white/10 transition-colors"
            >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: sel
                        ? `0 0 18px ${t.acc}45, inset 0 0 0 1px ${t.acc}30`
                        : hov
                  ...
                  >
                    ...
                    >
                      <p className="text-white text-[8px] font-semibold text-center leading-none">
                        {t.nombre}
                      </p>
                    </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onFocus={(e) => {
                    e.target.style.borderColor = `${tpl.acc}80`;
                  }}
                  onBlur={(e) => {
              ...
              <div>
                ...
                <input
                  ...
                  aria-label="Número de diapositivas"
                />
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    ...
                    style={{color: tpl.acc, opacity: 0.8}}
                  >
                    {tpl.desc}
                  </p>
                </div>
